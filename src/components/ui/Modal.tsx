...
const ModalActions: React.FC<ModalActionsProps> = ({ children, className = '' }) => {
  return (
    <div className={cn('flex items-center justify-end space-x-2 pt-4 border-t border-gray-200', className)}>
      {children}
    </div>
  )
}
